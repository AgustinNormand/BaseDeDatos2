...
(
    ...
    CONSTRAINT FK_AXFACTURA_FACTURA FOREIGN KEY (NRO) 
    REFERENCES FACTURA
);
...
BEGIN
   ...
   BEGIN
      UPDATE AXFACTURA
      SET NRO = NEW.NRO, DETALLES_RESTANTES = 3
      WHERE NRO = OLD.NRO;
...
GRANT UPDATE ON DETALLE TO TRIGGER TRG_AUFACTURA;

GRANT UPDATE ON AXFACTURA TO TRIGGER TRG_AUFACTURA;
